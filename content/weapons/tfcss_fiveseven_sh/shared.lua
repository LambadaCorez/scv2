...
SWEP.MuzzleFlashEffect = nil-- = false -- = ("tfcss_fiveseven")					-- must be the name of your swep
--redacted
SWEP.Category				= "STStealth2"
SWEP.Author				= ""
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= ""
...
SWEP.PrintName				= "5.7 Tactical"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("Weapon_FIVESEVEN-S")		-- Script that calls the primary fire sound
...
SWEP.VElements = {
	["supp"] = { type = "Model", model = "models/props_wasteland/laundry_basket001.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0, -2.951, -11.558), angle = Angle(0, 0, -180), size = Vector(0.017, 0.017, 0.148), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
